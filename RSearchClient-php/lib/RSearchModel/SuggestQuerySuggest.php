...
/**
 * SuggestQuerySuggest Class Doc Comment
 *
 * @category Class
 * @package  RSearch\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SuggestQuerySuggest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SuggestQuery_suggest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fuzzy'] === null) {
            $invalidProperties[] = "'fuzzy' can't be null";
        }

...
class RsearchApi
{
    ...
    /**
     * Operation getAdvancedMultiIndexSearchResults
     *
     * @param  \RSearch\Client\RSearchModel\IndexesSearchQuery $search Details of the search query (required)
     *
     * @throws \RSearch\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \RSearch\Client\RSearchModel\SearchSuccess
     */
    public function getAdvancedMultiIndexSearchResults($search)
    {
        list($response) = $this->getAdvancedMultiIndexSearchResultsWithHttpInfo($search);
        return $response;
    }

    /**
     * Operation getAdvancedMultiIndexSearchResultsWithHttpInfo
     *
     * @param  \RSearch\Client\RSearchModel\IndexesSearchQuery $search Details of the search query (required)
     *
     * @throws \RSearch\Client\ApiException on non-2xx response
     ...
     */
    public function getAdvancedMultiIndexSearchResultsWithHttpInfo($search)
    {
        $returnType = '\RSearch\Client\RSearchModel\SearchSuccess';
        $request = $this->getAdvancedMultiIndexSearchResultsRequest($search);
    ...
    /**
     * Operation getAdvancedMultiIndexSearchResultsAsync
     *
     * 
     *
     * @param  \RSearch\Client\RSearchModel\IndexesSearchQuery $search Details of the search query (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAdvancedMultiIndexSearchResultsAsync($search)
    {
        return $this->getAdvancedMultiIndexSearchResultsAsyncWithHttpInfo($search)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAdvancedMultiIndexSearchResultsAsyncWithHttpInfo
     *
     * 
     *
     * @param  \RSearch\Client\RSearchModel\IndexesSearchQuery $search Details of the search query (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAdvancedMultiIndexSearchResultsAsyncWithHttpInfo($search)
    {
        $returnType = '\RSearch\Client\RSearchModel\SearchSuccess';
        $request = $this->getAdvancedMultiIndexSearchResultsRequest($search);
    ...
    /**
     * Create request for operation 'getAdvancedMultiIndexSearchResults'
     *
     * @param  \RSearch\Client\RSearchModel\IndexesSearchQuery $search Details of the search query (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAdvancedMultiIndexSearchResultsRequest($search)
    {
        // verify the required parameter 'search' is set
        if ($search === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $search when calling getAdvancedMultiIndexSearchResults'
            );
        }

        $resourcePath = '/indexes/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getAdvancedMultiIndexSuggestResults
     *
     * @param  \RSearch\Client\RSearchModel\IndexesSuggestQuery $suggest Details of the suggest query (required)
     *
     * @throws \RSearch\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \RSearch\Client\RSearchModel\SuggestSuccess
     */
    public function getAdvancedMultiIndexSuggestResults($suggest)
    {
        list($response) = $this->getAdvancedMultiIndexSuggestResultsWithHttpInfo($suggest);
        return $response;
    }

    /**
     * Operation getAdvancedMultiIndexSuggestResultsWithHttpInfo
     *
     * @param  \RSearch\Client\RSearchModel\IndexesSuggestQuery $suggest Details of the suggest query (required)
     *
     * @throws \RSearch\Client\ApiException on non-2xx response
     ...
     * @return array of \RSearch\Client\RSearchModel\SuggestSuccess, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdvancedMultiIndexSuggestResultsWithHttpInfo($suggest)
    {
        $returnType = '\RSearch\Client\RSearchModel\SuggestSuccess';
        $request = $this->getAdvancedMultiIndexSuggestResultsRequest($suggest);
    ...
    /**
     * Operation getAdvancedMultiIndexSuggestResultsAsync
     *
     * 
     *
     * @param  \RSearch\Client\RSearchModel\IndexesSuggestQuery $suggest Details of the suggest query (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAdvancedMultiIndexSuggestResultsAsync($suggest)
    {
        return $this->getAdvancedMultiIndexSuggestResultsAsyncWithHttpInfo($suggest)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAdvancedMultiIndexSuggestResultsAsyncWithHttpInfo
     *
     * 
     *
     * @param  \RSearch\Client\RSearchModel\IndexesSuggestQuery $suggest Details of the suggest query (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAdvancedMultiIndexSuggestResultsAsyncWithHttpInfo($suggest)
    {
        $returnType = '\RSearch\Client\RSearchModel\SuggestSuccess';
        $request = $this->getAdvancedMultiIndexSuggestResultsRequest($suggest);
    ...
    /**
     * Create request for operation 'getAdvancedMultiIndexSuggestResults'
     *
     * @param  \RSearch\Client\RSearchModel\IndexesSuggestQuery $suggest Details of the suggest query (required)
     *
     * @throws \InvalidArgumentException
    ...
    /**
     * Operation getSimilarDocsResults
     *
     * @param  \RSearch\Client\RSearchModel\AlgorithmSimilarDocsQuery $algorithm Query defintions (required)
     *
     * @throws \RSearch\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \RSearch\Client\RSearchModel\AlgorithmSuccess
     */
    public function getSimilarDocsResults($algorithm)
    {
        list($response) = $this->getSimilarDocsResultsWithHttpInfo($algorithm);
        return $response;
    }

    /**
     * Operation getSimilarDocsResultsWithHttpInfo
     *
     * @param  \RSearch\Client\RSearchModel\AlgorithmSimilarDocsQuery $algorithm Query defintions (required)
     *
     * @throws \RSearch\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \RSearch\Client\RSearchModel\AlgorithmSuccess, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSimilarDocsResultsWithHttpInfo($algorithm)
    {
        $returnType = '\RSearch\Client\RSearchModel\AlgorithmSuccess';
        $request = $this->getSimilarDocsResultsRequest($algorithm);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RSearch\Client\RSearchModel\AlgorithmSuccess',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RSearch\Client\RSearchModel\AlgorithmFailure',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getSimilarDocsResultsAsync
     *
     * 
     *
     * @param  \RSearch\Client\RSearchModel\AlgorithmSimilarDocsQuery $algorithm Query defintions (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSimilarDocsResultsAsync($algorithm)
    {
        return $this->getSimilarDocsResultsAsyncWithHttpInfo($algorithm)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSimilarDocsResultsAsyncWithHttpInfo
     *
     * 
     *
     * @param  \RSearch\Client\RSearchModel\AlgorithmSimilarDocsQuery $algorithm Query defintions (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSimilarDocsResultsAsyncWithHttpInfo($algorithm)
    {
        $returnType = '\RSearch\Client\RSearchModel\AlgorithmSuccess';
        $request = $this->getSimilarDocsResultsRequest($algorithm);
    ...
    /**
     * Create request for operation 'getSimilarDocsResults'
     *
     * @param  \RSearch\Client\RSearchModel\AlgorithmSimilarDocsQuery $algorithm Query defintions (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSimilarDocsResultsRequest($algorithm)
    {
        // verify the required parameter 'algorithm' is set
        if ($algorithm === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $algorithm when calling getSimilarDocsResults'
            );
        }

        $resourcePath = '/indexes/algorithms/similardocs';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
